...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String userDefinePort = System.getProperty("port");
    	if(userDefinePort!=null){
    		try {
				port = Integer.valueOf(userDefinePort).intValue();
			} catch (Exception e) {
				System.err.println("!!!!what you define with -Dport is :"+userDefinePort+" hava a problem with:"+e.getMessage());
				System.err.println("due to the error befor , the defaule port : "+default_port+" will be used!");
				port = default_port;
			}
    	}
...
//        webapp.setDefaultsDescriptor("E:/work_dt/first-exec-war/src/main/webapp/META-INF/jetty/webdefault.xml");
		...
		try {
			...
			MyConnectionManager.free(conn, null, null);
		}
